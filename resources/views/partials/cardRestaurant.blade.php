			...
			<div class="col-4 mt-3">
				<div class="card p-0 h-100">
					<div class="row g-0 m-0">
						<div class="col-12">
							<img src="{{ $restaurant->image }}" class="img-fluid rounded-start mb-2" alt="immagine-progetto">
						</div>
						<h5 class="card-title"><b>Nome Piatto:</b> {{ $restaurant->name }}</h5>
					</div>
					<a href="{{ route('admin.restaurants.show', $restaurant->id) }}" class="btn btn-outline-primary my-2">Dettagli
						Piatto
						<i class="fa-solid fa-info"></i></a>
					<a href="{{ route('admin.restaurants.edit', $restaurant->id) }}" class="btn btn-outline-primary my-2">Modifica
						Piatto
						<i class="fa-solid fa-pencil"></i></a>

					<!-- Modal trigger button -->
					<button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
						data-bs-target="#modal-{{ $restaurant->id }}">Elimina Piatto
